...
export default function HeroHome({ priority = true }: HeroHomeProps) {
  return (
    <section
      className="relative flex min-h-[100dvh] flex-col items-center justify-between overflow-hidden px-3 pt-20 pb-5 text-center md:pt-25 xl:pt-10"
      aria-labelledby="hero-title"
    >
      <SpaceParticlesWrapper />

      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-purple-900/20 via-blue-900/10 to-transparent"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 flex flex-col items-center gap-3 md:gap-4">
        <FadeIn delay={0}>
          <h1
            id="hero-title"
            className="xs:text-3xl max-w-[1400px] bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-500 bg-clip-text text-2xl leading-tight font-extrabold text-transparent drop-shadow-[0_0_30px_rgba(168,85,247,0.4)] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl"
          >
        ...
        <FadeIn delay={0.4}>
          ...
          >
            <div
              className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 backdrop-blur-xl md:px-4 md:py-2"
              role="listitem"
            >
              <span className="text-xs font-bold text-cyan-400 md:text-sm">
                <span className="sr-only">Over </span>10,000+ Games
              </span>
            </div>
            <div
              className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 backdrop-blur-xl md:px-4 md:py-2"
            ...
            >
              <span className="text-xs font-bold text-purple-400 md:text-sm">
                <span className="sr-only">Over </span>500K+ Players
              </span>
            </div>
            <div
              className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 backdrop-blur-xl md:px-4 md:py-2"
      ...
      <div
        className="relative flex h-[200px] w-full items-center justify-center overflow-visible sm:h-[250px] md:h-[320px] lg:h-[400px]"
        aria-hidden="true"
      >
        <BaseImage
          src="/blackhole.webp"
      ...
      <FadeIn delay={0.6} className="flex w-full items-center justify-center">
        <nav
          className="relative z-10 mb-3 flex w-full flex-col items-center gap-2.5 md:mb-5 md:gap-3 xl:max-w-[600px] xl:flex-row"
