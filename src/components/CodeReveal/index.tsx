  ...
  return (
    <section className="flex w-full flex-col gap-6 px-3 py-8 md:gap-8 md:py-12">
      ...
      <ScaleIn delay={0.3} duration={0.8}>
        <div className="group relative flex w-full flex-col items-center justify-center rounded-xl border-2 border-purple-500/30 bg-gradient-to-br from-gray-900 via-black to-gray-900 px-5 pt-10 pb-6 shadow-[0_0_50px_rgba(139,92,246,0.2)] transition-all duration-500 hover:border-purple-500/50 hover:shadow-[0_0_80px_rgba(139,92,246,0.4)] md:px-6 md:pt-12 md:pb-8">
