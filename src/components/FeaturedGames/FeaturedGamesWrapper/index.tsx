...
export default function FeaturedGamesWrapper({
  ...
  return (
    ...
    >
      ...
      <div
        className={`from-blue-darkest/70 to-blue-darkest via-blue-darkest/90 absolute top-218 left-0 z-10 w-full rounded-t-[10px] bg-gradient-to-b transition-all ease-in-out md:top-118 ${isOpen ? "pointer-events-none h-full opacity-0 duration-1000" : "pointer-events-auto h-57 opacity-100 duration-1200"}`}
      />
