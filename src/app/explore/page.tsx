...
export default async function Explore() {
  ...
  return (
    <section
      className="flex flex-col gap-5 px-3 pt-25 text-2xl font-bold xl:pt-15"
    ...
    >
      <FadeIn delay={0}>
        <header>
          <h1
            id="explore-title"
            className="text-2xl leading-none font-black sm:text-3xl md:text-4xl lg:text-5xl"
          >
      ...
      <FadeIn delay={0.2}>
        <p className="text-xs leading-relaxed text-white/70 sm:text-sm md:text-base">
          ...
          <span className="relative inline-block">
            ...
            <span
              className="absolute right-0 bottom-0 left-0 h-2 bg-gradient-to-r from-cyan-400/20 to-purple-400/20 blur-sm"
              aria-hidden="true"
            />
          </span>{" "}
